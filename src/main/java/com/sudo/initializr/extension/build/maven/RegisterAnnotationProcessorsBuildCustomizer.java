...
package com.sudo.initializr.extension.build.maven;
...
class RegisterAnnotationProcessorsBuildCustomizer implements BuildCustomizer<MavenBuild> {
  ...
  public void customize(MavenBuild build) {
    ...
    List<Dependency> annotationProcessors = build
      .dependencies()
      .ids()
  ...
  private boolean isAnnotationProcessor(String id) {
    ...
    return (dependency != null) && io.spring.initializr.metadata.Dependency.SCOPE_ANNOTATION_PROCESSOR
